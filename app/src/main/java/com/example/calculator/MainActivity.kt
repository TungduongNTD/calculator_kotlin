                ...
                if(arith1 != true){
                    ...
                    if(arith2 != true){
                        ...
                        if(arith3 != true){
                            ...
                            Toast.makeText(binding.root.context, "Không thể nhập nhiều hơn 4 phép toán", Toast.LENGTH_SHORT).show()
                        }
                    }
                }
                resultSet = false
                            ...
                            "÷" -> {
                                when(cal2){
                                    "÷" -> {
                                        when(cal1){
                                            "÷" -> {
                                                result = String.format("%.7f", value1.toString().toDouble() / value2.toString().toDouble() / value3.toString().toDouble() / value4.toString().toDouble())
                                            ...
                                            "-" -> {
                                                valueCal1 = String.format("%.7f", value2.toString().toDouble() / value3.toString().toDouble() / value4.toString().toDouble())
                                                result = String.format("%.7f", value1.toString().toDouble() - valueCal1.toString().toDouble())
                                                binding.tvMain.setText(result)
                                            }
                                            "+" -> {
                                                valueCal1 = String.format("%.7f", value2.toString().toDouble() / value3.toString().toDouble() / value4.toString().toDouble())
                                    ...
                                    "-" -> {
                                        when(cal1){
                                            "÷" -> {
                                                valueCal1 = String.format("%.7f", value1.toString().toDouble() / value2.toString().toDouble())
                                                valueCal2 = String.format("%.7f", value3.toString().toDouble() / value4.toString().toDouble())
                                                result = String.format("%.7f", valueCal1.toString().toDouble() - valueCal2.toString().toDouble())
                                                binding.tvMain.setText(result)
                                            }
                                            "×" -> {
                                                valueCal1 = String.format("%.7f", value1.toString().toDouble() * value2.toString().toDouble())
                                            ...
                                            "-" -> {
                                                valueCal1 = String.format("%.7f", value3.toString().toDouble() / value4.toString().toDouble())
                                                result = String.format("%.7f", value1.toString().toDouble() - value2.toString().toDouble() - valueCal1.toString().toDouble())
                                                binding.tvMain.setText(result)
                                            }
                                            "+" -> {
                                                valueCal1 = String.format("%.7f", value3.toString().toDouble() / value4.toString().toDouble())
                            ...
                            "-" -> {
                                when(cal2){
                                    "÷" -> {
                                        when(cal1){
                                            "÷" -> {
                                                valueCal1 = String.format("%.7f", value1.toString().toDouble() / value2.toString().toDouble() / value3.toString().toDouble())
                                                result = String.format("%.7f", valueCal1.toString().toDouble() - value4.toString().toDouble())
                                                binding.tvMain.setText(result)
                                            }
                                            "×" -> {
                                                valueCal1 = String.format("%.7f", value1.toString().toDouble() * value2.toString().toDouble() / value3.toString().toDouble())
                                            ...
                                            "-" -> {
                                                valueCal1 = String.format("%.7f", value2.toString().toDouble() / value3.toString().toDouble())
                                                result = String.format("%.7f", value1.toString().toDouble() - valueCal1.toString().toDouble() - value4.toString().toDouble())
                                                binding.tvMain.setText(result)
                                            }
                                            "+" -> {
                                                valueCal1 = String.format("%.7f", value2.toString().toDouble() / value3.toString().toDouble())
                                    ...
                                    "-" -> {
                                        when(cal1){
                                            "÷" -> {
                                                valueCal1 = String.format("%.7f", value1.toString().toDouble() / value2.toString().toDouble())
                                                result = String.format("%.7f", valueCal1.toString().toDouble() - value3.toString().toDouble() - value4.toString().toDouble())
                                                binding.tvMain.setText(result)
                                            }
                                            "×" -> {
                                                valueCal1 = String.format("%.7f", value1.toString().toDouble() * value2.toString().toDouble())
                    ...
                    if(arith2 == true){
                        ...
                        if(value1.toString().contains(".") || value2.toString().contains(".") || value3.toString().contains(".")){
                            when(cal2){
                                "÷" -> {
                                    when(cal1){
                                        "÷" -> {
                                            result = String.format("%.7f", value1.toString().toDouble() / value2.toString().toDouble() / value3.toString().toDouble())
                                            binding.tvMain.setText(result)
                                        }
                                        "×" -> {
                                            result = String.format("%.7f", value1.toString().toDouble() * value2.toString().toDouble() / value3.toString().toDouble())
                                ...
                                "-" -> {
                                    when(cal1){
                                        "÷" -> {
                                            valueCal1 = String.format("%.7f", value1.toString().toDouble() / value2.toString().toDouble())
                                            result = String.format("%.7f", valueCal1.toString().toDouble() - value3.toString().toDouble())
                                            binding.tvMain.setText(result)
                                        }
                                        "×" -> {
                                            valueCal1 = String.format("%.7f", value1.toString().toDouble() * value2.toString().toDouble())
                        ...
                        if(arith1 == true){
                            ...
                            if(value1.toString().contains(".") || value2.toString().contains(".")){
                                when(cal1){
                                    "÷" -> {
                                        result = String.format("%.7f", value1.toString().toDouble() / value2.toString().toDouble())
                                        binding.tvMain.setText(result)
                                    }
                                    "×" -> {
                                        result = String.format("%.7f", value1.toString().toDouble() * value2.toString().toDouble())
